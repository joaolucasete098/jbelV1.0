module.exports = (client, message, args, RichEmbed, prefix, welcome) => {
    ...
    if (message.guild.channels.get(welcome.welcome._idChannel)) {
        canalWelcome = `${client.getEmoji("oni")} Ativo | Canal: <#${welcome.welcome._idChannel}>, ${prefix}welcome off welcome`;
    }
    ...
    if (message.guild.channels.get(welcome.saida._idChannel)) {
        canalSaida = `${client.getEmoji("oni")} Ativo | Canal: <#${welcome.saida._idChannel}>, ${prefix}welcome off saida`;
    }
    ...
    if (welcome.privado.length) {
        let txt = welcome.privado.length > 800 ? `${welcome.privado.slice(0, 801)}[...]` : welcome.privado;
