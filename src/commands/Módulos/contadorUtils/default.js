module.exports = (client, message, args, RichEmbed, prefix, contador) => {
    let embed = new RichEmbed()
        ...
        .setTimestamp();
    if (contador.status) {
        embed.addField("Canal | Define o canal do contador:", `${client.getEmoji("oni")} Ativo | Canal: <#${contador._idChannel}>, ${prefix}contador off`, false);
    } else {
